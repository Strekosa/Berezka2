...
function berezka_setup() {
	...
	register_nav_menus(
		array(
			'main-menu' => esc_html__( 'Main Menu', 'berezka' ),
		)
	);
...
function berezka_scripts() {
    ...
    wp_localize_script('berezka-navigation', 'my_ajax_object',
...
{
    $labels = array(
        'name' => __('Popularity', 'example-theme'),
        'singular_name' => __('Popularity', 'example-theme'),
        'search_items' => __('Search Popularity', 'example-theme'),
        'all_items' => __('All Popularity', 'example-theme'),
        'parent_item' => __('Parent Popularity', 'example-theme'),
        'parent_item_colon' => __('Parent Popularity:', 'example-theme'),
        'edit_item' => __('Edit Popularity', 'example-theme'),
        'update_item' => __('Update Popularity', 'example-theme'),
        'add_new_item' => __('Add New Popularity', 'example-theme'),
        'new_item_name' => __('New Popularity Name', 'example-theme'),
        'menu_name' => __('Popularity', 'example-theme')
    );
    $args = array(
        'hierarchical' => true,
        'labels' => $labels,
    ...
    register_taxonomy('popularity', array('rooms',), $args);
